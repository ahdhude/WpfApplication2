...
Partial Public Class Database1DataSet
    ...
    Partial Public Class UserDataTable
        ...
        Private Sub InitClass()
            ...
            Me.columnpassword.MaxLength = 70
        End Sub
...
Namespace Database1DataSetTableAdapters
    ...
    Partial Public Class UserTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [User] WHERE (([Id] = @Original_Id) AND ((@IsNull_password = 1 AND [p"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [User] ([username], [password]) VALUES (@username, @password);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELEC"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [User] SET [username] = @username, [password] = @password WHERE (([Id] = @"& _ 
                "Original_Id) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] ="& _ 
                " @Original_password)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, username, password FROM [User] WHERE (Id = @"& _ 
                "Id)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WpfApplication2.MySettings.Default.Database1ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(2).CommandText = "INSERT INTO [User]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         (username, password)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"VALUES        "& _ 
                "(@username,@password); "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, username, password FROM [User] WHERE (Id = S"& _ 
                "COPE_IDENTITY())"
            ...
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@password", Global.System.Data.SqlDbType.NChar, 70, Global.System.Data.ParameterDirection.Input, 0, 0, "password", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As Database1DataSet.UserDataTable, ByVal username As String) As Integer
        ...
        Public Overloads Overridable Function GetDataBy1(ByVal username As String) As Database1DataSet.UserDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (username Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
        ...
        Public Overloads Overridable Function InsertQuery(ByVal username As String, ByVal password As String) As Integer
